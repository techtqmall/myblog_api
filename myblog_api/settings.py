...
"""
from myblog_api.config.log import *  # 日志配置
from myblog_api.config.simpleui import *  # Django simple UI配置
from myblog_api.config.other import *  # 密钥，默认值等其他配置
import datetime
import os
...
# JWT配置
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(minutes=10),  # 配置过期时间
}
